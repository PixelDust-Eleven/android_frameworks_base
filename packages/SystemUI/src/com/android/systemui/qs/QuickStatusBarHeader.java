...
public class QuickStatusBarHeader extends RelativeLayout implements
        ...
        ZenModeController.Callback, LifecycleOwner, OmniSettingsService.OmniSettingsObserver, TunerService.Tunable {
    ...
    public void onTuningChanged(String key, String newValue) {
        if (QS_SHOW_BRIGHTNESS_SLIDER.equals(key)) {
            ...
            updateResources();
        } else if (QS_SHOW_BRIGHTNESS_POSITION_BOTTOM.equals(key)) {
            mShowQuickQsBrightnessBottom = TunerService.parseIntegerSwitch(newValue, true);
            updateResources();
        }
    }
